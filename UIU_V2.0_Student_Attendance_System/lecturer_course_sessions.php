...
if (!$course) {
    // This course doesn't belong to this lecturer - block access
...
// Get sessions with Attended/Absent counts, filtered by month if selected
...
<head>
    ...
    <link rel="stylesheet" href="lecturer_course_sessions.css">
    ...
    <main>
        <section>
            ...
            <div class="table-container">
                ...
                <form method="get" action="lecturer_course_sessions.php" class="month-filter-form">
                ...
                <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-buttons">
                                        <a href="lecturer_session_update.php?id=<?php echo $session['session_id']; ?>" class="btn-update">Update</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="empty_message">No sessions found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
                </table>
