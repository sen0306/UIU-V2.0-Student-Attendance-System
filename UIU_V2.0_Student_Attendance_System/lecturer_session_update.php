...
// Get session info, but only if it belongs to a course assigned to this lecturer
...
$stmt->bind_param("ss", $session_id, $lecturer_id);
$stmt->execute();
$session = $stmt->get_result()->fetch_assoc();

if (!$session) {
    // This session doesn't belong to this lecturer - block access
...
// Count Attended/Absent for the summary bar
...
<head>
    ...
    <link rel="stylesheet" href="lecturer_session_update.css">
    ...
    <main>
        <section>
            <div class="left-arrow">
                <a href="lecturer_course_sessions.php?id=<?php echo $session['course_id']; ?>"><i class="fa-solid fa-angle-left"></i></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-buttons">
                                        <a href="lecturer_update_attendance_process.php?session_id=<?php echo $session_id; ?>&student_id=<?php echo $student['student_id']; ?>&status=Attended" class="btn-attended">Attended</a>
                                        <a href="lecturer_update_attendance_process.php?session_id=<?php echo $session_id; ?>&student_id=<?php echo $student['student_id']; ?>&status=Absent" class="btn-absent">Absent</a>
                                        <a href="lecturer_update_attendance_process.php?session_id=<?php echo $session_id; ?>&student_id=<?php echo $student['student_id']; ?>&status=<?php echo urlencode('Absent with Excuse'); ?>" class="btn-excused">Excused</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endwhile; ?>
